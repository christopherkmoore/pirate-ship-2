...
struct Settings {
    ...
    struct Messages {
        ...
        static let HumanHitMonster = "You've hit a sea monster! You've given CP a freebie"
        static let ComputerHitMonster = "The computer has hit a sea monster! LOOOOOOOOOOOOOOOOL! noice."
